...
// Initialize components after full page load to avoid layout thrash before styles are ready
function scheduleComponentInit() {
      ...
      if (html && html.trim()) {
        ...
        Array.from(scriptTags).forEach(oldScript => {
          ...
          try {
            ...
            console.warn('Failed to replace script in component:', e);
          }
        });
